...
function process1() {
    ...
    if(r < 0){
        ...
        alert("El rango supera la capacidad de cálculo, debe elegir entre 0 y 100");
    } else {
        alert("El área del círculo es: " + round(circleArea(r),2));
        document.getElementById('out1').innerHTML = "El área del círculo es: " +  round(circleArea(r),2);
    }
}
...
function process2(){
    ...
    if((l1 < 0 | l2 < 0) && (l1 > 100 | l2 > 100)){
        alert("El largo de los lados no puede ser negativo \n" +
              "El rango supera la capacidad de cálculo, los lados deben ser menores a 100");
    } else if(l1 < 0 | l2 < 0){
        alert("El largo de los lados no puede ser negativo");
    } else if(l1 > 100 | l2 > 100) {
        alert("El rango supera la capacidad de cálculo, los lados deben ser menores a 100");
    } else {
...
function process3(){
    ...
    if((h < 0 | b < 0) && (h > 100 | b > 100)){
        alert("La base y la altura no puede ser negativas \n" +
              "El rango supera la capacidad de cálculo, base y altura deben ser menores a 100");
    } else if(h < 0 | b < 0){
        alert("La base y la altura no puede ser negativas");
    } else if(h > 100 | b > 100) {
        alert("El rango supera la capacidad de cálculo, base y altura deben ser menores a 100");
    } else {
